  ...
  //  if(privated == false){
    ...
    try {
      jwt.verify(token, 'secret', { expiresIn: '30d' }, async function(err, decoded) {
        ...
        //   CREATE TABLE firmware_handler (
        //     uid INT PRIMARY KEY NOT NULL,
        // CHANGE ON BACK ! //     creation_date VARCHAR(40) NULL,
        //     description VARCHAR(500) NULL,
        //     firmwareData VARCHAR NULL,
        //     id VARCHAR(80),
        //     version VARCHAR(10)
        // );

          const res = pool.query( "INSERT INTO firmware_handler ( id, creationdate, description, firmwaredata, version ) VALUES ($1, $2,$3, $4,$5) RETURNING *",
